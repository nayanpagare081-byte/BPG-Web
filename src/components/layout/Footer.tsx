      ...
      <div className="max-w-container-max mx-auto px-md grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-2">
          <img
            src="/images/logo.png"
            alt="BPG Logo"
            className="h-20 md:h-24 w-auto object-contain self-start mb-2"
          />
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-on-surface-variant text-sm leading-relaxed">
            Subscribe for exclusive access to new collections and equipment
            updates.
          </p>
        ...
        <div className="col-span-1 md:col-span-4 mt-8 pt-6 border-t border-outline-variant/30 text-on-surface-variant text-sm">
          <span>
            © 2024 BPG Construction & Earthmoving Equipment. All rights
            reserved.
          </span>
        </div>
      </div>
